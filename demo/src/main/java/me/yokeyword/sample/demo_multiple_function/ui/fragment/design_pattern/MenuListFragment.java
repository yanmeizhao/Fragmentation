...
import me.yokeyword.sample.demo_multiple_function.adapter.MenuAdapter;
import me.yokeyword.sample.demo_multiple_function.base.BaseFragment;
import me.yokeyword.sample.demo_multiple_function.listener.OnItemClickListener;
...
public class MenuListFragment extends BaseFragment {
    ...
    private void showContent(int position) {
        ...
        if(getParentFragment() instanceof DesignPatternsFragment) {
            ((DesignPatternsFragment) getParentFragment()).switchContentFragment(fragment);
        } else if(getParentFragment() instanceof DatePickerDialogFragment) {
            ((DatePickerDialogFragment) getParentFragment()).switchContentFragment(fragment);
        }
    }
